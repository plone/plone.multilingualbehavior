...
if HAVE_EDITOREXTENDER:
    ...
    class IFieldLanguageIndependent(Interface):
        languageindependent = schema.Bool(
            ...
            description=PMF(u'The field is going to be copied on all translations when you edit the content'),
            required=False)
    ...
    class FieldLanguageIndependentAdapter(object):
        ...
        languageindependent = property(_read_languageindependent, _write_languageindependent)

    # IFieldLanguageIndependent could be registered directly as a named adapter providing IFieldEditorExtender
    ...
    provideAdapter(get_li_schema, provides=IFieldEditorExtender, name='plone.schemaeditor.languageindependent')
